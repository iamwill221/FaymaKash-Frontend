...
class _RegisterWidgetState extends State<RegisterWidget>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.phoneNumberTextController?.text = '+221';
        }));
  }
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        'Nous vous enverrons un code OTP!',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyLarge
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'Ce code permettra de vérifier que vous êtes bien le propriétaire du numéro',
                                                      ...
                                                      child: RichText(
                                                        ...
                                                        text: TextSpan(
                                                          children: [
                                                            TextSpan(
                                                              text:
                                                                  'Entrez le code que nous avons envoyé sur votre numéro : ',
                                                              style:
                                                                  TextStyle(),
                                                            ),
                                                            TextSpan(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 4.0, 0.0, 8.0),
                                            child: Text(
                                              'Entrez votre prénom et nom de famille pour nous permettre de sécuriser votre compte.',
                                              textAlign: TextAlign.start,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                          ...
                                          if (false)
                                            FlutterFlowDropDown<String>(
                                              controller: _model
                                                      .userTypeDropDownValueController ??=
                                                  FormFieldController<String>(
                                                _model.userTypeDropDownValue ??=
                                                    'client',
                                              ),
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 4.0, 0.0, 8.0),
                                            child: Text(
                                              'Choisis ton code pin qui te permettra de sécuriser ton compte Fayma Kash',
                                              textAlign: TextAlign.start,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                            ...
                            onPressed: () async {
                              ...
                              if (_model.pageViewCurrentIndex == 0) {
                                ...
                                if (_model.formKey3.currentState == null ||
                                  ...
                                  safeSetState(() => _model.ff = false);
                                  return;
                                }
                                _model.phoneNumber =
                                    _model.phoneNumberTextController.text;
                                _model.otpSent =
                                    await AuthGroup.sendOTPCall.call(
                                  phoneNumber:
                                      _model.phoneNumberTextController.text,
                                );

                                if ((_model.otpSent?.succeeded ?? true)) {
                                  // controlPageView
                                ...
                                _model.otpVerificationResult =
                                    await AuthGroup.verifyOTPCall.call(
                                  phoneNumber: _model.phoneNumber,
                                  otp: _model.oTPCode!.text,
                                );

                                if ((_model.otpVerificationResult?.succeeded ??
                                    true)) {
                                  // controlPageView
                                  await _model.pageViewController?.nextPage(
                                    duration: Duration(milliseconds: 300),
                                ...
                                _model.lastName = _model.nomTextController.text;
                                // controlPageView
                                await _model.pageViewController?.nextPage(
                                  duration: Duration(milliseconds: 300),
                                  curve: Curves.ease,
                                ...
                                if ((_model.registrationResult?.succeeded ??
                                    true)) {
                                  ...
                                  await authManager.signIn(
                                    ...
                                    authUid: UserStruct.maybeFromMap((_model
                                                .registrationResult?.jsonBody ??
                                            ''))
                                        ?.phoneNumber,
                                    userData: UserStruct.maybeFromMap(
                                        (_model.registrationResult?.jsonBody ??
                                            '')),
                                  );
