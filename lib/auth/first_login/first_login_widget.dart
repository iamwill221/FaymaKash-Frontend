      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              if (_model.currentPageViewIndex <= 0) {
                context.pop();
              } else {
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if (_model.pageViewCurrentIndex == 0) {
                                ...
                                _model.checkUserExistenceResult =
                                    await AuthGroup.checkUserExistenceCall.call(
                                  phoneNumber:
                                      _model.phoneNumberTextController.text,
                                );

                                if (AuthGroup.checkUserExistenceCall.exists(
                                  (_model.checkUserExistenceResult?.jsonBody ??
                                      ''),
                                )!) {
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Erreur'),
                                        content: Text(
                                            'Aucun compte n\'est lié à ce numéro de téléphone'),
                                        actions: [
                                          TextButton(
